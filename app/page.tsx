      ...
      <div className="container mx-auto px-4 py-12 md:py-16">
        <div className="max-w-7xl mx-auto">
          ...
          <section className="mb-12 mt-16 md:mt-20">
            ...
            <div className="w-full">
              <a
                href="https://www.google.com/maps/dir//Lungomare+Peppino+Impastato,+1,+90049+Terrasini+PA/@38.1582971,13.0933176,2747m/data=!3m1!1e3!4m8!4m7!1m0!1m5!1m1!1s0x1319917a2a245f6f:0x8325bfa3472381d1!2m2!1d13.0789229!2d38.1538094?entry=ttu&g_ep=EgoyMDI1MTIwOS4wIKXMDSoASAFQAw%3D%3D"
                target="_blank"
